...
public class Grapple : MonoBehaviour
{
    ...
    private GameObject grapHead; //Ссылка на игровой обэект, представляющий начало крюка
    private LineRenderer grapLine; //Ссылка на компонент LineRenderer объекта Grappler
    ...
    void FixedUpdate()
    {
        switch(mode)
        {
            case eMode.gOut: //Крюк брошен
                ...
                //Проверить, попали ли крюк куда-нибудь
                ...
                {
                    //Крюк улетел на всю длину веревки, но не куда не попал
                    mode = eMode.gInMiss;
                }
                break;

            case eMode.gInMiss:
                //Игрок промахнулся, вернуть крюк на удвоенной скорости
            ...
            case eMode.gInHit:
                //Крюк зацепился, поднять Дрея на стену
    ...
    void StopGrapple()
    {
        ...
        {
            //Дрей попал на небезопасную зону
